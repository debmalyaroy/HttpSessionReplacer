    ...
    public static void methods(String className, ClassVisitor cw, boolean addStaticInit) {
        ...
        }
        {
            ...
            mv.visitMethodInsn(INVOKESTATIC, className, "$$context",
                    "(Ljavax/servlet/ServletRequest;Ljavax/servlet/ServletContext;)Ljavax/servlet/ServletContext;",
                    false);
        ...
        {
            mv = cw.visitMethod(ACC_PUBLIC + ACC_STATIC, "$$initSessionManagement", "(Ljavax/servlet/ServletContext;)V",
                    null, null);
            mv.visitCode();
            Label l0 = new Label();
            mv.visitLabel(l0);
        ...
        }
        {
            mv = cw.visitMethod(ACC_PUBLIC + ACC_STATIC, "$$commitRequest",
                    "(Ljavax/servlet/ServletRequest;Ljavax/servlet/ServletRequest;Ljavax/servlet/ServletContext;)V",
                    null, null);
            mv.visitCode();
            Label l0 = new Label();
            mv.visitLabel(l0);
        ...
        {
            mv = cw.visitMethod(ACC_PRIVATE + ACC_STATIC + ACC_VARARGS, "$$debug",
        ...
        {
            mv = cw.visitMethod(ACC_PRIVATE + ACC_STATIC, "$$getPropertySecured",
