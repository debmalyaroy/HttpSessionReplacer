...
public class ServletContextHelpers implements Opcodes {
    ...
    public static void methods(String className, ClassVisitor cw, boolean addStaticInit) {
        ...
        {
            mv = cw.visitMethod(ACC_PUBLIC + ACC_STATIC, "$$onAddListener", "(Ljava/lang/Object;Ljava/lang/Object;)V",
                    null, null);
            mv.visitCode();
            Label l0 = new Label();
            mv.visitLabel(l0);
            ...
            mv.visitVarInsn(ALOAD, 0);
            mv.visitInsn(AASTORE);
            mv.visitMethodInsn(INVOKESTATIC, className, "$$error", "(Ljava/lang/String;[Ljava/lang/Object;)V", false);
            Label l3 = new Label();
            mv.visitLabel(l3);
