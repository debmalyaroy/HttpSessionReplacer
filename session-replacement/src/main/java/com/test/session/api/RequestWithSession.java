...
public interface RequestWithSession {
     ...
     *
     * <p>
     * As with HttpSession from servlet specification, to make sure the session
     * is properly maintained, you must call this method before the response is
     ...
     *
     * @return the {@link RepositoryBackedSession} associated with this request
     *         or <code>null</code> if <code>create</code> is <code>false</code>
     *         and the request has no valid session
     *
     */
    RepositoryBackedHttpSession getRepositoryBackedSession(boolean create);
