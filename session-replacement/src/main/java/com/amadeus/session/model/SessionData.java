package com.amadeus.session.model;
 ...
 * <li>the id of node that previously owned the session (may be the same as
 * current</li>
...
public class SessionData {
    ...
    /**
     * Constructor with session id, last epoch time of access, maximum
     * inactivity interval, creation time (from epoch) and node id of previous
     * owner.
     *
     * @param id
     *            the session id
    ...
    /**
     * Retrieves set of keys for this session that have been stored in
     * repository. If the value is <code>null</code>, then the set has yet not
     * been retrieved from repository
     *
    ...
    /**
     * Sets the set of keys that have been stored in repository for this
     * session.
     *
     * @param repositoryKeys
     *            set of keys that have been stored in repository
     */
    public void setRepositoryKeys(Set<String> repositoryKeys) {
     ...
     *
     * @return keys whose attributes must be stored and retrieved from
     *         repository
     */
    ...
    /**
     * Returns session id that was used to retrieve session from store. As the
     * id may change during request, we need original id to access the
     * repository.
     *
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.SIMPLE_STYLE).append("id", id)
                .append("oldSessionId", oldSessionId).append("creationTime", creationTime)
                .append("lastAccessedTime", lastAccessedTime).append("maxInactiveInterval", maxInactiveInterval)
                .append("repositoryKeys", repositoryKeys).append("mandatoryRemoteKeys", mandatoryRemoteKeys)
                .append("isNew", isNew).append("originalLastAccessed", originalLastAccessed)
                .append("previousOwner", previousOwner).toString();
    }
    ...
    public boolean equals(final Object other) {
        ...
        SessionData castOther = (SessionData) other;
        return Objects.equals(id, castOther.id) && Objects.equals(oldSessionId, castOther.oldSessionId)
                && Objects.equals(creationTime, castOther.creationTime)
                && Objects.equals(lastAccessedTime, castOther.lastAccessedTime)
                && Objects.equals(maxInactiveInterval, castOther.maxInactiveInterval)
                && Objects.equals(repositoryKeys, castOther.repositoryKeys)
                && Objects.equals(mandatoryRemoteKeys, castOther.mandatoryRemoteKeys)
                && Objects.equals(isNew, castOther.isNew)
                && Objects.equals(originalLastAccessed, castOther.originalLastAccessed)
                && Objects.equals(previousOwner, castOther.previousOwner);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, oldSessionId, creationTime, lastAccessedTime, maxInactiveInterval, repositoryKeys,
                mandatoryRemoteKeys, isNew, originalLastAccessed, previousOwner);
    }
}
