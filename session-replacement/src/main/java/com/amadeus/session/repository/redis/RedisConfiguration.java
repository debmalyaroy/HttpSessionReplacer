...
public class RedisConfiguration {
    ...
    /**
     * System or configuration property that specifies expiration strategy used
     * by redis.
     */
    ...
    /**
     * System or configuration property that specifies port of redis server(s)
     * or sentinel(s).
     */
    ...
    /**
     * System or configuration property that specifies the redis clustering
     * mode. Can be SINGLE, SENTINEL or CLUSTER.
     */
        ...
        if (strategy == null) {
            ...
            try {
                ...
                if (logger.isWarnEnabled()) {
                    logger.warn("Unknown expiration strategy. Got: `{}`, supported: {}, Excepion: {}",
                            expirationStrategy, Arrays.asList(ExpirationStrategy.values()), e);
                }
    ...
    /**
     * Reads IP address support configuration. Implementation may support IPv4
     * and IPv6.
     */
    ...
    /**
     * Utility method to extract host and port from configuration. Used for
     * Redis cluster name resolution.
     *
    ...
    public String toString() {
        ...
        builder.append("RedisConfiguration [clusterMode=").append(clusterMode).append(", masterName=")
                .append(masterName).append(", server=").append(server).append(", port=").append(port)
                .append(", poolSize=").append(poolSize).append(", strategy=").append(strategy).append(", supportIpV6=")
                .append(supportIpV6).append(", supportIpV4=").append(supportIpV4).append(", timeout=").append(timeout)
                .append("]");
