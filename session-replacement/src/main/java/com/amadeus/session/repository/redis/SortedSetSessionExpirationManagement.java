...
class SortedSetSessionExpirationManagement implements RedisExpirationStrategy {
    ...
    public void startExpiredSessionsTask(final SessionManager sessionManager) {
        ...
        // Interval of polling is either 1/10th of the maximum inactive
        // interval, or
    ...
    final class CleanupTask implements Runnable {
         ...
         * @param forceExpire
         *            if set to true, sessions are expired even if they don't
         *            belong to this node
         */
    ...
    /**
     * Extracts session id from byte array stripping owner node if it was
     * present.
     * 
     * @param session
