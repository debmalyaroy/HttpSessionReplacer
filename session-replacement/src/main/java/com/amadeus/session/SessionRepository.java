...
public interface SessionRepository extends Closeable {
    ...
    interface CommitTransaction {
        ...
        /**
         * Set to <code>true</code> if all attributes must be committed. If set
         * to <code>false</code>, only the attributes that were changed or
         * deleted need to be committed.
         *
        ...
        /**
         * Returns <code>true</code> if executing the transaction results in
         * session data being distributed to remote store.
         *
         * @return <code>true</code> if executing the transaction results in
         *         session data being distributed to remote store.
         */
