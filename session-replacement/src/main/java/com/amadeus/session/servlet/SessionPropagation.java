...
/**
 * This enum contains supported session tracking mechanism. Currently COOKIE and
 * URL session tracking are supported. See also {@link CookieSessionTracking}
 * and {@link UrlSessionTracking}.
 */
