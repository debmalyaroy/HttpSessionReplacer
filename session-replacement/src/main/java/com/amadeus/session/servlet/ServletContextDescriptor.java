...
public class ServletContextDescriptor {
    ...
    /**
     * Adds {@link HttpSessionIdListener} associated to {@link ServletContext}
     * to list of known listeners. Listener is added only if it has not been
     * seen before. As session id listeners were introduced in Servlet 3.1, the
     * method takes EventListener as parameter in order to be compatible older
     * containers.
     *
     * @param listener
     */
    public void addHttpSessionIdListener(EventListener listener) {
    ...
    /**
     * Returns list of {@link HttpSessionIdListener}. As session id listeners
     * were introduced in Servlet 3.1, the method has EventListener in signature
     * in order to be compatible older containers.
     *
     * @return list of listeners or empty if there are nor registered listeners
     */
