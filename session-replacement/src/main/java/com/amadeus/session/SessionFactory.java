...
public interface SessionFactory {
    ...
    /**
     * Callback to associated {@link SessionManager} with this instance of
     * factory.
     *
     ...
     * changed. It is up to session factory to implement any needed logic. E.g.
     * if it uses cache it can rename it here.
     *
     * @param sessionData
