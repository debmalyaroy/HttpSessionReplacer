package com.amadeus.session.wrappers;
 ...
 * propagated.
 */
public class HttpResponseWrapper extends SlingHttpServletResponseWrapper implements ResponseWithSessionId {
     ...
     */
    public HttpResponseWrapper(HttpRequestWrapper request, HttpServletResponse response) {
        super((SlingHttpServletResponse) response);
     ...
     *
     * @return writer that tracks when we need to write headers and commit
     *         session
     * @throws IOException
    ...
    class SaveSessionServletOutputStream extends ServletOutputStream {
        ...
        /**
         * Sets associated {@link Closeable} object. If stream is be associated
         * to another {@link Closeable} object, when {@link #close()} method is
         * called, the associated object will be closed.
         *
         * @param associated
